...
import com.listen.otic.db.QueueEntity
import com.listen.otic.models.MediaID
import com.listen.otic.models.MediaID.Companion.CALLER_OTHER
import com.listen.otic.models.MediaID.Companion.CALLER_SELF
import com.listen.otic.models.Song
import com.listen.otic.notifications.Notifications
import com.listen.otic.repository.SongsRepository
import com.listen.otic.constants.Constants
import com.listen.otic.constants.Constants.ACTION_NEXT
import com.listen.otic.constants.Constants.ACTION_PLAY_NEXT
import com.listen.otic.constants.Constants.ACTION_PREVIOUS
import com.listen.otic.constants.Constants.ACTION_QUEUE_REORDER
import com.listen.otic.constants.Constants.ACTION_REPEAT_QUEUE
import com.listen.otic.constants.Constants.ACTION_REPEAT_SONG
import com.listen.otic.constants.Constants.ACTION_RESTORE_MEDIA_SESSION
...
import com.listen.otic.constants.Constants.APP_PACKAGE_NAME
import com.listen.otic.constants.Constants.QUEUE_FROM
import com.listen.otic.constants.Constants.QUEUE_TO
import com.listen.otic.constants.Constants.REPEAT_MODE
import com.listen.otic.constants.Constants.SHUFFLE_MODE
...
import com.listen.otic.util.Utils.EMPTY_ALBUM_ART_URI
import com.listen.otic.util.doAsync
import com.listen.otic.util.doAsyncPost
import com.listen.otic.extensions.isPlayEnabled
import com.listen.otic.extensions.isPlaying
import com.listen.otic.extensions.moveElement
import com.listen.otic.extensions.position
import com.listen.otic.extensions.toIDList
import com.listen.otic.extensions.toQueue
import com.listen.otic.extensions.toRawMediaItems
...
import com.listen.otic.db.QueueDao
import com.listen.otic.db.QueueHelper
import com.listen.otic.repository.AlbumRepository
import com.listen.otic.repository.ArtistRepository
import com.listen.otic.repository.GenreRepository
...
class OticAudioService : MediaBrowserServiceCompat(), MediaPlayer.OnPreparedListener,
    ...
    override fun onCreate() {
        ...
        mediaSession.run {
            if (ContextCompat.checkSelfPermission(this@OticAudioService,
            ...
            override fun onPlayFromMediaId(mediaId: String?, extras: Bundle?) {
                ...
                extras?.let {
                    doAsync {
                        ...
                        queueTitle?.let { this@OticAudioService.queueTitle = it }
                        setPlaybackState(stateBuilder.setState(mediaSession.controller.playbackState.state,
                                seekTo.toLong(), 1F).build())
                        mediaSession.setQueue(currentQueue.toQueue(songsRepository))
                        mediaSession.setQueueTitle(this@OticAudioService.queueTitle)
                    }.execute()
                }
            }
    ...
    private fun startService() {
        log("startService()")
        if (!isStarted) {
            val intent = Intent(this, OticAudioService::class.java)
            startService(intent)
    ...
    private fun initPlayer() {
        ...
        player = MediaPlayer().apply {
            ...
            setOnPreparedListener(this@OticAudioService)
            setOnCompletionListener(this@OticAudioService)
            setOnErrorListener(this@OticAudioService)
        }
    }
